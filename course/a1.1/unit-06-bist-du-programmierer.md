# A1.1 Unit 6 — Bist du Programmierer?

**Source:** `courses/a1.1/` + LÖSUNGEN · **Setting:** Im Café · **Met:** 2026-09-20 · **Ingested**
...
- [`Was machst du beruflich?`](../../patterns/patterns.md#was-machst-du-beruflich) — new
- [`Das ist … / Er / Sie / Sie`](../../patterns/patterns.md#das-ist----er--sie--sie) — new
- [`ihr` vs `Sie` (plural you)](../../patterns/patterns.md#ihr-vs-sie-plural-you) — new
- *arbeiten* (+ stem *t/d/n/m* → extra *e*) · job *-in* — [`notes.md`](notes.md)
...
6. Trap: *Ich bin eine Lehrerin* · *sie* vs *Sie* · *ihr* to strangers
