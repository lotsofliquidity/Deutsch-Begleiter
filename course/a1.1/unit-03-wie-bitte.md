...
- [`du` vs `Sie`](../../patterns/patterns.md#du-vs-sie)
- [`Sind Sie frei?`](../../patterns/patterns.md#sind-sie-frei)
- [`Woher kommen Sie? / Ich wohne in X.`](../../patterns/patterns.md#woher-kommen-sie--ich-wohne-in-x)
- [`Bar oder mit Karte?`](../../patterns/patterns.md#bar-oder-mit-karte) — new
- *sein* · *wohnen/leben* — [`notes.md`](notes.md)

## Drill ladder

1. Guten Tag! Sind Sie noch frei?
2. Wohin wollen Sie fahren? → Nach …
3. Woher kommen Sie? → Ich komme aus … / Ich wohne in …
4. Ich verstehe nicht. Können Sie das noch mal wiederholen?
5. Wie viel kostet das? → Bar oder mit Karte? → Ich zahle bar.
6. Trap: *Und du?* to the driver · *Ich wohne aus …* · *mit bar*
