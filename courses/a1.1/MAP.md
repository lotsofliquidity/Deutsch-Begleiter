...
|---|---|---|---|---|
| 1 | Hallo, wie geht’s? | Im Flugzeug | ingested | 1–24 |
...
|---|---|---|
| 1 Woher kommst du? | informal greetings, *Wie geht’s?*, *denn*, *man* | *kommen* |
| 2 Welche Sprachen sprichst du? | languages | *sprechen*; Q&A |
| 3 Wie heißt du? | asking name (informal), ß, *eigentlich* | *heißen* |

## Unit 2 — Ich brauche Hilfe!

| Dialog | Themen | Grammatik |
|---|---|---|
| 1 Ich habe eine Frage. | formal greetings, numbers 0–10 | — |
| 2 Wie heißt das? | asking / apologising | definite article |
| 3 Ich brauche eine Karte. | beginner survival phrases (*Wie sagt man…*), thanks, goodbye (informal) | — |

## Unit 3 — Wie bitte?

| Dialog | Themen | Grammatik |
|---|---|---|
| 1 Sind Sie frei? | *du* vs *Sie*, alphabet, *wohin* | *sein* |
| 2 Woher kommen Sie? | country names | *kommen aus*, *wohnen/leben in* |
| 3 Bar oder mit Karte? | numbers 11–20, paying (*bar* / *mit Karte*) | — |

## Unit 4 — Willkommen Frau Koch!

| Dialog | Themen | Grammatik |
|---|---|---|
| 1 Ich habe eine Reservierung. | *Wie geht es Ihnen?*, formal name, Frau/Herr | — |
